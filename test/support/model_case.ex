defmodule PhoenixElmBoilerplate.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import PhoenixElmBoilerplate.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&PhoenixElmBoilerplate.ErrorHelpers.translate_error/1)
