defmodule PhoenixElmBoilerplate.UserAuthService do
  use PhoenixElmBoilerplate.Web, :service
  alias PhoenixElmBoilerplate.{Repo, User, Enums.UserType, Enums.Status}
  alias PhoenixElmBoilerplate.Authorization
